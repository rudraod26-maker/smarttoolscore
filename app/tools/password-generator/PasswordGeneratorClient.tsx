...
export default function PasswordGeneratorClient() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-black transition-colors duration-300 px-6 py-16">
      <div className="w-full max-w-2xl backdrop-blur-lg bg-transparent/10 border border-white/20 shadow-2xl rounded-2xl p-8 text-white">
        ...
        <div className="mb-6">
          ...
          <div className="w-full h-3 bg-transparent/20 rounded">
            <div
        ...
        <div className="space-y-3">
          {passwords.map((pwd, index) => (
            <div
              key={index}
              className="flex justify-between items-center bg-transparent/10 px-4 py-3 rounded-lg font-mono"
            >
